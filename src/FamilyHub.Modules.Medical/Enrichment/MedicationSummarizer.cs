...
public class MedicationSummarizer(ILmStudioJsonClient client, ILogger<MedicationSummarizer> logger)
{
        ...
        string displayName, IReadOnlyList<WebSnippet> snippets, CancellationToken ct = default)
    {
        ...
        // источника (все они уже прошли фильтр TrustedDomains у провайдера) — иначе в справочник
        // не пишем вовсе, не только текст без ссылок (см. task-5.1-medications.md).
