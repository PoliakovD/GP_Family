...
public static class PromptCatalog
{
    ...
    [
        ...
        new("analysis.title", "Короткое название анализа (заметка 4) — отдельный LLM-проход по шапке документа " +
            "и уже извлечённым показателям, точнее поля внутри analysis.extract."),
