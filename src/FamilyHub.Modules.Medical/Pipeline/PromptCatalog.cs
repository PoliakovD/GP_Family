...
public static class PromptCatalog
{
    ...
    [
        ...
        new("analysis.subject-resolve", "Уточнение родового названия показателя по документу (посев на конкретный " +
            "микроорганизм, аллерген и т.п.) — когда таблица результатов печатает только родовое слово, а объект " +
            "исследования назван отдельно, обычно в разделе «Оказанные услуги»."),
        ...
        new("analysis.qualitative-judge", "Оценка нормы по смыслу свободного текста, когда референса в бланке нет, " +
            "а результат не раскладывается ни диапазоном, ни полярностью «обнаружено/не обнаружено» (шкалы " +
            "обильности, описательные находки мазков) — самый дорогой и самый редкий резервный шаг каскада."),
