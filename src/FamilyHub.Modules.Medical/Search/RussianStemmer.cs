...
/// in-memory поиска по расшифрованным медкартам совпадало с Postgres-FTS по лекарствам/справочнику,
/// см. ADR-0003). Оперирует регионами RV/R1/R2 (как в Porter2): последовательно снимает
/// перфективное деепричастие/возвратный постфикс/окончание прилагательного-причастия-глагола-
/// существительного, затем "и", затем деривационное окончание в R2, затем упрощает "нн"→"н"
/// и снимает финальный мягкий знак/превосходную степень. Без внешних зависимостей (без Lucene.NET).
/// </summary>
