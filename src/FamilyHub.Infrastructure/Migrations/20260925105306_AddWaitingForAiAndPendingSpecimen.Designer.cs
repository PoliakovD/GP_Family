...
namespace FamilyHub.Infrastructure.Migrations
{
    ...
    [Migration("20260925105306_AddWaitingForAiAndPendingSpecimen")]
    partial class AddWaitingForAiAndPendingSpecimen
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FamilyHub.Domain.Entities.CredentialRotation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("FromIdentity")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
                    ...
                    b.Property<int?>("TerminatedSessions")
                        .HasColumnType("integer");

                    b.Property<string>("ToIdentity")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
            ...
            modelBuilder.Entity("FamilyHub.Domain.Entities.KbRebuildRun", b =>
                {
                    ...
                    b.Property<int>("CacheMerged")
                        .HasColumnType("integer");

                    b.Property<int>("CatalogDeleted")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("FinishedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("IndicatorsMerged")
                        .HasColumnType("integer");

                    b.Property<int>("IndicatorsUpdated")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ReseedRequested")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("KbRebuildRuns", (string)null);
                });
            ...
            modelBuilder.Entity("FamilyHub.Domain.Entities.LabIndicator", b =>
                {
                    ...
                    b.Property<string>("RawDisplayName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.HasIndex("MedicalRecordId", "AnalyteKey", "SpecimenKbId")
                        .IsUnique();

                    b.HasIndex("OwnerUserId", "FamilyDependentId", "TargetUserId", "AnalyteKey", "SpecimenKbId");

                    b.ToTable("LabIndicators", "medical");
                });

            modelBuilder.Entity("FamilyHub.Domain.Entities.LmStudioModelConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("LmStudioModelConfigs", (string)null);
                });

            modelBuilder.Entity("FamilyHub.Domain.Entities.LmStudioReasoningConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("LmStudioReasoningConfigs", (string)null);
                });
            ...
            modelBuilder.Entity("FamilyHub.Domain.Entities.MedicalRecord", b =>
                {
                    ...
                    b.Property<string>("PendingSpecimenText")
                        .HasColumnType("text");

                    b.Property<DateOnly>("RecordDate")
                        .HasColumnType("date");

                    b.Property<string>("SpecimenHint")
                        .HasColumnType("text");

                    b.Property<Guid>("SpecimenKbId")
                        .HasColumnType("uuid");

                    b.Property<DateTime?>("SummaryDirtyAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("FamilyHub.Domain.Entities.Notification", b =>
                {
                    ...
                    b.Property<int?>("RelatedEntityKind")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FamilyHub.Domain.Entities.PipelinePrompt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PipelinePrompts", (string)null);
                });

            modelBuilder.Entity("FamilyHub.Domain.Entities.PipelinePromptVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PipelinePromptVersions", (string)null);
                });

            modelBuilder.Entity("FamilyHub.Domain.Entities.PipelineStepConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PipelineKey", "StepKey")
                        .IsUnique();

                    b.ToTable("PipelineStepConfigs", (string)null);
                });
            ...
            modelBuilder.Entity("FamilyHub.Domain.Entities.SearchWarmupRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("PaidCalls")
                        .HasColumnType("integer");

                    b.Property<int>("SkippedFreshCache")
                        .HasColumnType("integer");

                    b.Property<int>("SkippedKbHit")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SearchWarmupRuns", (string)null);
                });
            ...
            modelBuilder.Entity("FamilyHub.Domain.Entities.UserSpecimen", b =>
                {
                    ...
                    b.HasIndex("OwnerUserId", "SpecimenKbId")
                        .IsUnique();
            ...
            modelBuilder.Entity("FamilyHub.Domain.Entities.WebSearchConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("WebSearchConfigs", (string)null);
                });
            ...
            modelBuilder.Entity("FamilyHub.Domain.Entities.PipelinePromptVersion", b =>
                {
                    b.HasOne("FamilyHub.Domain.Entities.PipelinePrompt", "Prompt")
                        .WithMany()
