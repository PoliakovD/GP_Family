...
public class MedicalRecord
{
    ...
    /// Job получает его при постановке и молча выходит, если к моменту запуска токен уже другой
    /// (пользователь успел внести ещё правку — та поставила свою, более свежую джобу; дебаунс).
