...
`0011` учётки приложения Postgres/MinIO, `0012` MinIO собственной сборки, `0013` недоступный ИИ (очередь «ждём ИИ»), `0014` отчёт для врача (публичная ссылка), `0015` напоминания о приёме лекарств (push с кнопками).
